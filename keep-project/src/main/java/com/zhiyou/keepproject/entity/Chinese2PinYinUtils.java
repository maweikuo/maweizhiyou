package com.zhiyou.keepproject.entity;
...
public class Chinese2PinYinUtils {
    ...
    private static Chinese2PinYinUtils chineseSpelling = new Chinese2PinYinUtils();

    public static Chinese2PinYinUtils getInstance() {
    ...
    public static String trans2PinYin(String str) {
        return Chinese2PinYinUtils.getInstance().convertAll(str).toUpperCase();
    }
